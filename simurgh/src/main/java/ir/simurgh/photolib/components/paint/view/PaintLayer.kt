...
/**
 * Represents a single layer in the [PainterView].
 *
 ...
 *
 * it works similarly to layers in professional image editing software,
...
data class PaintLayer(
    ...
    /**
     * Compares this layer with another for equality.
     *
