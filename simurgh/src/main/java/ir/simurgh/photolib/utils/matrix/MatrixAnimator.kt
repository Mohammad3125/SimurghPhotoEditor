package ir.simurgh.photolib.utils.matrix
 ...
 */
open class MatrixAnimator(
    protected var targetMatrix: SimurghMatrix,
    protected var initialBounds: RectF,
    animationDuration: Long,
    animationInterpolator: TimeInterpolator
) {
    protected var onMatrixUpdateCallback: ((SimurghMatrix) -> Unit)? = null
     ...
     */
    open fun setOnMatrixUpdateListener(callback: (SimurghMatrix) -> Unit) {
    ...
    interface OnMatrixUpdateListener {
         ...
         */
        fun onMatrixUpdated(matrix: SimurghMatrix)
    }
}